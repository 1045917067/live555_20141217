...
#include "H264CBStreamFramer.hh"
#include "MPEGVideoStreamParser.hh"
#include "H264VideoRTPSource.hh" // for "parseSPropParameterSets()"

////////// H264CBStreamParser definition //////////

class H264CBStreamParser: public MPEGVideoStreamParser
{
public:
...
////////// H264CBStreamFramer implementation //////////

H264CBStreamFramer* H264CBStreamFramer
::createNew(UsageEnvironment &env, FramedSource *inputSource, Boolean includeStartCodeInOutput)
{
  return new H264CBStreamFramer(env, inputSource, True, includeStartCodeInOutput);
}

H264CBStreamFramer
::H264CBStreamFramer(UsageEnvironment& env, FramedSource* inputSource, Boolean createParser, Boolean includeStartCodeInOutput)
