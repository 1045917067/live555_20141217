...
class H264VideoCBFramedSource: public CBFramedSource
{
public:
    static H264VideoCBFramedSource * createNew(UsageEnvironment &env, STREAM_CALLBACK_FXN fxn, void *userdata);
...
protected:  // we're the virtual function
    ...
    H264VideoCBFramedSource(UsageEnvironment &env, STREAM_CALLBACK_FXN fxn, void *userdata);

    virtual ~H264VideoCBFramedSource();
